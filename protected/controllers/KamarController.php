...
class KamarController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','index','cetakKamar'),
				'users'=>array('@'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Kamar']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->kode_kamar));
		}
	...
	public function actionCetakKamar(){
		...
		$pdf=new LaporanKamar('L','mm',array('215','330'));
		$pdf->cetakKamar();
	}
	 ...
	 * @param Kamar $model the model to be validated
	 */
